...
public class CORSFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
		...
		response.setHeader("Access-Controller-Allow-Methods", "POST, GET, PUT, OPTIONS, DELETE");
		response.setHeader("Access-Controller-Allow-Credentials", "true");
		response.setHeader("Access-Controller-Allow-Max-Age", "3600");
		response.setHeader("Access-Controller-Allow-Headers", "X-Request-With, Content-Type, " + 
